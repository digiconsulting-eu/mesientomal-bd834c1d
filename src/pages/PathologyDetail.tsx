          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 border border-sky-500">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-gray-600 mb-2">Difficoltà di Diagnosi</p>
                ...
                <div>
                  <p className="text-gray-600 mb-2">Fastidio Sintomi</p>
                  <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-gray-600 mb-2">Efficacia Cura Farmacologica</p>
                  <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-gray-600 mb-2">Possibilità di Guarigione</p>
                  <div className="flex items-center gap-2">
                    <span className="text-3xl font-bold">{averages?.healingPossibility || '0.0'}</span>
                    <Badge variant="secondary">{getLevelBadge(averages?.healingPossibility || 0)}</Badge>
                  </div>
                ...
                <div>
                  <p className="text-gray-600 mb-2">Disagio Sociale</p>
                  <div className="flex items-center gap-2">
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="bg-sky-50 rounded-lg p-6">
                <h2 className="text-xl font-semibold text-sky-500 mb-2">Panoramica</h2>
              </div>

              <div className="bg-sky-50 rounded-lg p-6">
                <h2 className="text-xl font-semibold text-sky-500 mb-2">Leggi Esperienze</h2>
              </div>

              <div className="bg-sky-50 rounded-lg p-6">
                <h2 className="text-xl font-semibold text-sky-500 mb-2">Racconta la tua Esperienza</h2>
              </div>

              <div className="bg-white rounded-lg p-6 border border-sky-500">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-semibold">Cos'è {name}?</h2>
                ...
                <p className="text-gray-700">
                  {pathologyData?.Descrizione || 'Descrizione non disponibile.'}
                </p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-sky-500">
                <h2 className="text-xl font-semibold mb-4">Esperienze ({reviews?.length || 0})</h2>
                {reviews?.length === 0 ? (
                  <p className="text-gray-600">Non ci sono ancora esperienze per questa patologia.</p>
                ) : (
